            ...
            <td style="padding: 0 24px 16px 24px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #1f2430; border-left: 4px solid #64b5f6; border-radius: 4px;">
                <tr><td style="padding: 14px 16px;">
                  ...
                  ${data.weeklySuperlatives.worstCoach ? `<p style="margin: 8px 0 0 0; font-size: 13px; color: #e0e0e0;"><strong>Most points left on bench:</strong> ${escapeHtml(data.weeklySuperlatives.worstCoach.teamName)} left ${data.weeklySuperlatives.worstCoach.benchPoints.toFixed(1)} on the bench.${data.weeklySuperlatives.worstCoach.sitStartMiss ? ` ${escapeHtml(data.weeklySuperlatives.worstCoach.sitStartMiss)}` : ""}</p>` : ""}
                  ${data.weeklySuperlatives.bestCoach ? `<p style="margin: 8px 0 0 0; font-size: 13px; color: #e0e0e0;"><strong>Least bench waste:</strong> ${escapeHtml(data.weeklySuperlatives.bestCoach.teamName)} left only ${data.weeklySuperlatives.bestCoach.benchPoints.toFixed(1)} on the bench.${data.weeklySuperlatives.bestCoach.note ? ` ${escapeHtml(data.weeklySuperlatives.bestCoach.note)}` : ""}</p>` : ""}
                </td></tr>
              </table>
            </td>
          </tr>
            ...
            <td style="padding: 0 24px 16px 24px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #26211f; border-left: 4px solid ${accent}; border-radius: 4px;">
                <tr><td style="padding: 14px 16px;">
                  ...
                  ${data.seasonRaces.luckiestByPointsAgainst ? `<p style="margin: 8px 0 0 0; font-size: 13px; color: #e0e0e0;"><strong>Softest schedule (lowest PA):</strong> ${escapeHtml(data.seasonRaces.luckiestByPointsAgainst.teamName)} — ${data.seasonRaces.luckiestByPointsAgainst.totalPointsAgainst.toFixed(1)} against (${data.seasonRaces.luckiestByPointsAgainst.pointsAgainstPerGame.toFixed(1)}/game).</p>` : ""}
                  ${data.seasonRaces.unluckiestByPointsAgainst ? `<p style="margin: 8px 0 0 0; font-size: 13px; color: #e0e0e0;"><strong>Toughest schedule (highest PA):</strong> ${escapeHtml(data.seasonRaces.unluckiestByPointsAgainst.teamName)} — ${data.seasonRaces.unluckiestByPointsAgainst.totalPointsAgainst.toFixed(1)} against (${data.seasonRaces.unluckiestByPointsAgainst.pointsAgainstPerGame.toFixed(1)}/game).</p>` : ""}
                </td></tr>
              </table>
            </td>
          </tr>
  ...
  if (!isPreview && data.rankings && data.rankings.length > 0) {
    ...
    if (data.recapReady !== false && data.weeklySuperlatives) {
      ...
      if (data.weeklySuperlatives.worstCoach) {
        lines.push(`Most points left on bench: ${data.weeklySuperlatives.worstCoach.teamName} left ${data.weeklySuperlatives.worstCoach.benchPoints.toFixed(1)} points on the bench.${data.weeklySuperlatives.worstCoach.sitStartMiss ? ` ${data.weeklySuperlatives.worstCoach.sitStartMiss}` : ""}`);
      }
      if (data.weeklySuperlatives.bestCoach) {
        lines.push(`Least bench waste: ${data.weeklySuperlatives.bestCoach.teamName} left only ${data.weeklySuperlatives.bestCoach.benchPoints.toFixed(1)} on the bench.${data.weeklySuperlatives.bestCoach.note ? ` ${data.weeklySuperlatives.bestCoach.note}` : ""}`);
      }
    ...
    if (data.seasonRaces) {
      ...
      if (data.seasonRaces.luckiestByPointsAgainst) lines.push(`Softest schedule (lowest points against): ${data.seasonRaces.luckiestByPointsAgainst.teamName} — ${data.seasonRaces.luckiestByPointsAgainst.totalPointsAgainst.toFixed(1)} (${data.seasonRaces.luckiestByPointsAgainst.pointsAgainstPerGame.toFixed(1)}/game).`);
      if (data.seasonRaces.unluckiestByPointsAgainst) lines.push(`Toughest schedule (highest points against): ${data.seasonRaces.unluckiestByPointsAgainst.teamName} — ${data.seasonRaces.unluckiestByPointsAgainst.totalPointsAgainst.toFixed(1)} (${data.seasonRaces.unluckiestByPointsAgainst.pointsAgainstPerGame.toFixed(1)}/game).`);
    }
