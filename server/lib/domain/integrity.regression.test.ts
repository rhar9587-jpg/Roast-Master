 ...
 *   weeklyCommissioner.slateStatus.test.ts, weeklyPublicShare.test.ts,
 *   finalitySurfaceConsistency.test.ts, RoastCard.slateStatus.test.ts
 * - Season outcomes: seasonOutcome.test.ts, shared/seasonComplete
